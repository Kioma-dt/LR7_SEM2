...
class Pair{
    public:
        ...
        Pair(Pair<T1, T2> &&other) noexcept: first(std::move(other.first)), second(std::move(other.second)) {};
        ...
        template <typename U1, typename U2>
        Pair(U1 &&fir, U2 &&sec) : first(std::forward<U1>(fir)), second(std::forward<U2>(sec)) {};
