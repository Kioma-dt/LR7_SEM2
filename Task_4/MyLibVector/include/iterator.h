...
class ReverseIterator{
    ...
    public:
        ...
        ReverseIterator operator-(ReverseIterator<T>::difference_type n) const;
        ReverseIterator<T>::difference_type operator-(const ReverseIterator &other) const;

        ReverseIterator<T>::reference operator[](ReverseIterator<T>::difference_type n) const;
...
class ConstReverseIterator : public ReverseIterator<const T>{
    ...
    ConstReverseIterator(const T *pointer) : ReverseIterator<const T>(pointer){};
};
